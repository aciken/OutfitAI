...
const USER_BACKEND_URL = 'https://47f1-109-245-193-150.ngrok-free.app'; // Base URL for your backend
  ...
  const pickImage = async (source) => {
    ...
    try {
      ...
      if (!result.canceled && result.assets && result.assets.length > 0) {
        ...
        const backendResponse = await axios.put(`https://47f1-109-245-193-150.ngrok-free.app/newImage`, {
          userID: userID,
          newFileId: newFileId,
